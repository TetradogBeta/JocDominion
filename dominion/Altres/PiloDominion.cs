...
namespace dominion
{
    public partial class PiloDominion : UserControl
    {
        ...
        public PiloDominion(Bitmap carta): this()
        {
            imatgeDeFons = carta;
        }
        ...
        {/*
            ...
            set
            {
                if (value != mostraNumeroDeCartes)
           
                {
               
                    mostraNumeroDeCartes = value; 
               
                    Refresh(); 
           
                }
            }*/
            get {return mostraNumeroDeCartes;}
            set { mostraNumeroDeCartes = value;
                Refresh(); 
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!(Buida))
            {
                BackgroundImage = imatgeDeSobre;   
            }
            else
            {
                BackgroundImage = ImatgeDeFons;    
                //BackgroundImage = (Bitmap)dominion.CartaVictoria.Finca.Finca.;
            }
        ...
        public void Posar(CartaDominion carta)
        {
            pila.Push(carta);
            Refresh();
        }
